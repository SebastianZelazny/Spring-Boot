...
<body>
	...
	<sf:form id="usersForm" action="updatepass" modelAttribute="user"
		...
		<!-- 
			<tr>
				<td width="130" align="right"><s:message
						code="passwordChange.oldPassword" /></td>
				<td width="270" align="left"><sf:password path="oldPassword"
						size="28" /></td>
			</tr>		
		...
		-->	
			...
			<tr>
				<td width="130" align="right"><s:message
						code="passwordChange.confirmPassword" /></td>
				<td width="270" align="left"><sf:password path="confirmPassword"
						size="28" /></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><font color="red"><sf:errors
			...
			<!-- allow to validate inputs <tr>
				<td width="270" align="left"><c:out value="${user.newPassword}" /></td>
				
			</tr>
			<tr><td width="270" align="right"><c:out value="${user.confirmPassword}" /></td></tr>  -->
			<tr>
