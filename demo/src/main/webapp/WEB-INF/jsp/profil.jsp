...
<body>
	...
	<table width="500" border="0" cellpadding="4" cellspacing="1"
		...
		<tr>
			...
			<td width="270" align="left"><c:out value="${user.lastName}" /></td>
		</tr>
		<tr>
			<td width="130" align="right"><s:message
			...
			<td width="270" align="left"><c:choose>
					<c:when test="${user.active == 1}">
						<s:message code="word.tak"></s:message>
					</c:when>
					<c:otherwise>
		...
		<tr>
			...
			<td width="270" align="left"><c:choose>
					<c:when test="${user.nrRoli == 1}">
						<s:message code="word.admin"></s:message>
					</c:when>
					<c:otherwise>
	...
	<table width="500" border="0" cellpadding="4" cellspacing="1"
		...
		<tr>
			...
			<td align="center"><input type="button"
				value="<s:message code= "button.changeProfile" />"
